                ...
                <div className='max-w-screen-xl md:mx-auto px-4 -mt-20'>
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                        ...
                        <div className='w-[100%] md:w-[75%] grid grid-cols-1 gap-4' data-aos="fade-up">
                            ...
                            <p data-aos="fade-up">
                                At Miracka, we believe in providing peerless creative solutions in order to assist each client flourish in their business. As a digital marketing company, we make it a priority to recognise the objectives of each client's business.
                            </p>
                            <p data-aos="fade-up">
